...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            ...
            { '&zIndex': 2, width: 600, height: 242, top: 61, left: 0, $opacity: 0.6 },
            /* { '&zIndex': 3, width: 170, height: 218, top: 37, left: 110, $opacity: 0.7 },*/
            { '&zIndex': 4, width: 700, height: 300, top: 0, left: 262, $opacity: 1 },
            /*  { '&zIndex': 3, width: 170, height: 218, top: 37, left: 468, $opacity: 0.7 },*/
            { '&zIndex': 2, width: 600, height: 242, top: 61, left: 620, $opacity: 0.6 }
        ...
        this.$ele.find('div:nth-of-type(2)').on('click', function () {
            this.stop()
            this.next()
            this.play()
        }.bind(this))
        // 点击切换到上一张
        this.$ele.find('div:nth-of-type(1)').on('click', function () {
            this.stop()
            this.prev()
            this.play()
        }.bind(this))
